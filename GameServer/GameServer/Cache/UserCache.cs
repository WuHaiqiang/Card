...
namespace GameServer.Cache
{
    ...
    public class UserCache
    {
        ...
        /// 账号id 对应的 角色id
        /// </summary>
        private Dictionary<int, int> accIdUIdDic = new Dictionary<int, int>();
        //ConcurrentDictionary //表示可由多个线程同时访问的键值对的线程安全的集合 ///lock
        ...
        {
            return accIdUIdDic.ContainsKey(accountId);
        }
        ...
        {
            int userId = accIdUIdDic[accountId];
